...
--
-- Host: localhost    Database: wowragnaros_cms
-- ------------------------------------------------------
...
INSERT INTO `bugtracker` VALUES
(1,'Battle Chicken Does Not Despawn','<p>Gnomish Battle Chicken does not depsawn after 1.50 min and stays up until its dead.</p><p>&nbsp;</p><p><strong><span style=\"font-size: 14pt;\">Expected behavior</span></strong></p><ul><li>It should be up for 1.50 min or until its destroyed.</li></ul><p><strong><span style=\"font-size: 14pt;\">Steps to reproduce</span></strong></p><ul><li>Learn Engineering, adjust skill &gt;= 230</li><li>Add Gnomish Battle Chicken into inventory (10725) and equip</li><li>Use it and wait for 1.50 min</li></ul>','',8,2,1,1659139200,1,0);
...
--
-- Dumping data for table `bugtracker_priority`
--

LOCK TABLES `bugtracker_priority` WRITE;
/*!40000 ALTER TABLE `bugtracker_priority` DISABLE KEYS */;
INSERT INTO `bugtracker_priority` VALUES
(1,'High'),
(2,'Medium'),
(3,'Low');
/*!40000 ALTER TABLE `bugtracker_priority` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `bugtracker_status`
--

LOCK TABLES `bugtracker_status` WRITE;
/*!40000 ALTER TABLE `bugtracker_status` DISABLE KEYS */;
INSERT INTO `bugtracker_status` VALUES
(1,'New Report'),
...
(7,'Invalid'),
(8,'Resolved');
/*!40000 ALTER TABLE `bugtracker_status` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `bugtracker_type`
--

LOCK TABLES `bugtracker_type` WRITE;
/*!40000 ALTER TABLE `bugtracker_type` DISABLE KEYS */;
INSERT INTO `bugtracker_type` VALUES
(1,'Achievements'),
(2,'Battle Pets'),
...
(1,'Battle Chicken Does Not Despawn','<p>This CMS is tested with vMaNGOS Latest Stable Build - 19bc922ec4db0b2ee2a864bd3eae1d14991ed135</p>',1659139200);
...
--
-- Dumping data for table `donate_logs`
--

LOCK TABLES `donate_logs` WRITE;
/*!40000 ALTER TABLE `donate_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `donate_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
(1,'WoW Ragnaros (Windows)','Zip','5.5 GB ~',1,'wow-vanilla.png','Http://wowragnaros.com/clients/wowragnaros_windows.zip'),
(2,'Github Addon List','Zip','N/A',2,'../game-icons/chest.png','https://forum.twinstar.cz/threads/github-list-of-vanilla-addons-1-12-1.123906/'),
(3,'WoW Ragnaros (Mac/Intel)','Zip','5.5 ~ GB',1,'wow-vanilla.png','http://wowragnaros.com/clients/wowragnaros_mac_intel.zip'),
(4,'WoW Ragnaros - Burning Crusade (Windows)','Zip','9.5 GB ~',1,'wow-tbc.png','http://wowragnaros.com/clients/wowragnaros_bc_windows.zip');
...
(1,'Announcements',1,'Anything related about the server','forums/forum_005.png',3),
(2,'Help & Support',1,'You can get all the support related to your account here.','forums/forum_016.png',1),
(3,'General',2,'General section about anything related with game','forums/forum_010.png',3);
...
(1,1,'Hello World!',1,1659139200,'<p>Welcome.</p>',0,0);
...
(1,'PvP Rankings','pvp','fas fa-fist-raised',1,16,1),
(2,'Forums','forum','fas fa-comments',1,0,1),
(3,'Online Players','online','fas fa-user',1,16,1),
(4,'Armory','armory','fas fa-users',1,16,1),
(5,'Database','database','fas fa-database',1,16,1),
(6,'Account','#','fas fa-house-user',2,0,1),
(10,'Bugtracker','bugtracker','fas fa-bug',1,16,1),
(11,'Changelogs','changelogs','fas fa-scroll',1,6,1),
(12,'Downloads','download','fas fa-download',1,0,1),
(13,'Terms of Use','page/terms-of-use','fas fa-book-open',1,6,1),
(16,'Game Portal','#','fas fa-book',2,0,1);
...
--
-- Dumping data for table `mod_actions`
--

LOCK TABLES `mod_actions` WRITE;
/*!40000 ALTER TABLE `mod_actions` DISABLE KEYS */;
/*!40000 ALTER TABLE `mod_actions` ENABLE KEYS */;
UNLOCK TABLES;
...
(1,'Welcome to your new playground!','<p>Welcome to WoW Ragnaros - the best Scandinavian vanilla server!</p>\r\n<p>&nbsp;</p>\r\n<p>What we offer:</p>\r\n<ul>\r\n<li>10x XP rate (Until 1st of September)</li>\r\n<li>10x Gold rate (Until 1st of September)</li>\r\n<li>Over 400 bots ready at your command 24/7<br>\r\n<ul>\r\n<li>Bots do roam around Azeroth questing and doing battlegrounds</li>\r\n<li>You can invite bots that are +- 5 levels to your party!</li>\r\n<li>The bots will t</li>\r\n</ul>\r\n</li>\r\n</ul>','news_default.jpg',1723904164),
(2,'1000Mbit connection!','<p>WoW Ragnaros is hosted on a beefy 1GB fiber connection! No lag, only frags</p>','news_default_2.jpg',1723904191);
...
--
-- Dumping data for table `ranks_default`
--

LOCK TABLES `ranks_default` WRITE;
/*!40000 ALTER TABLE `ranks_default` DISABLE KEYS */;
INSERT INTO `ranks_default` VALUES
(1,'Rank Admin'),
(2,'Rank Visitor'),
(3,'Rank User');
/*!40000 ALTER TABLE `ranks_default` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `realms` (
  ...
  `expansion` int(11) NOT NULL COMMENT '0 = Vanilla, 1 = TBC, 2 = Wrath, and so on...',
  `realmd_database` varchar(50) NOT NULL,
  `world_database` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
...
(1,'10.0.1.30','cmangos','madafakka','cmangos_characters',1,'10.0.1.30','ADMINISTRATOR','ADMINISTRATOR',7878,'MaNGOS',0,'cmangos_realmd','cmangos_mangosd'),
(3,'10.0.1.23','cmangos','madafakka','tbc_characters',1,'10.0.1.23','ADMINISTRATOR','ADMINISTRATOR',7878,'MaNGOS',1,'tbc_realmd','tbc_mangosd');
...
(1,'WoW-Ragnaros - Both Classic AND The Burning Crusade!','WoW-Ragnaros features both Classic and The Burning Crusade, you only need 1 account for all of them!',1,'s-1.jpg'),
(2,'YesilCMS - Slide Page 2','Showcase for multi-page slideshow.',1,'s-2.jpg');
...
(1,'Buy shadowcraft set','Here u can bget the whole shadowcraft',1,1,1,1000,0,'inv_belt_45','additem \"Shadowcraft Gloves\"');
...
--
-- Dumping data for table `store_top`
--

LOCK TABLES `store_top` WRITE;
...
CREATE TABLE `timeline` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'JSON for MySQL, LONGTEXT for MariaDB' CHECK (json_valid(`description`)),
  `patch` varchar(16) NOT NULL,
  `date` date NOT NULL DEFAULT '0000-00-00' COMMENT 'YYYY-MM-DD',
...
(105,'ablohme','alex@le.com',1724428646,0,1,0,0);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `users_activation_status`
--

DROP TABLE IF EXISTS `users_activation_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `users_activation_status` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `email` varchar(100) NOT NULL,
  `hash` varchar(64) NOT NULL,
  `ip` varbinary(16) DEFAULT NULL COMMENT 'Machine Readable v4/v6, requires > MySQL v5.6',
  `status` tinyint(1) DEFAULT NULL COMMENT '-1 = Expired, 0 = Not Used/Activated, 1 = Used/Activated',
  `requested_at` int(10) unsigned DEFAULT NULL,
...
--
-- Dumping data for table `users_activation_status`
--

LOCK TABLES `users_activation_status` WRITE;
/*!40000 ALTER TABLE `users_activation_status` DISABLE KEYS */;
INSERT INTO `users_activation_status` VALUES
(1,'alex@le.com','z49LeYgd3TwKuNVFqEFopy4E7I1vLXtNcGC5uf-O2rjUXkB69h0sg02822dBrOUf','Q¶àp',0,1724428646,NULL);
/*!40000 ALTER TABLE `users_activation_status` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `votes_logs`
--

LOCK TABLES `votes_logs` WRITE;
/*!40000 ALTER TABLE `votes_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `votes_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `zones` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10049 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-28 20:13:13
