    ...
    <div class="uk-container">
        <div class="uk-grid uk-grid-small uk-margin-small" data-uk-grid>
            ...
            <div class="uk-width-auto">
                <a href="<?= base_url('admin/accounts'); ?>" class="uk-icon-button"><i class="fas fa-arrow-left"></i></a>
            </div>
        </div>
                ...
                <div class="uk-grid uk-grid-medium" data-uk-grid>
                    ...
                    <div class="uk-width-3-4@s">
                        ...
                        <?php else : ?>
                            ...
                            <?= form_close(); ?>
                        <?php endif; ?>
                        <?php if ($this->wowauth->getRank($idlink) > '0') : ?>
                            ...
                            <div class="uk-grid uk-grid-small uk-margin-small-top uk-margin-remove-bottom" data-uk-grid>
                                <div class="uk-width-1-2@s">
                                    <div class="uk-form-controls">
                                        <p><?= $this->lang->line('placeholder_gmlevel'); ?>: <?= $this->wowauth->getRank($idlink) ?></p>
                                    </div>
                ...
                <div class="uk-card uk-card-secondary">
                    <ul class="uk-nav uk-nav-default" uk-switcher="connect: #acc-characters">
                        <?php foreach ($this->wowrealm->getRealms()->result() as $realm) : ?>
                            <li><a href="javascript:void(0)"><i class="fas fa-server"></i> <?= $this->wowrealm->getRealmName($realm->id); ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($this->wowrealm->getGeneralCharactersSpecifyAcc($multiRealm, $idlink)->result() as $chars) : ?>
                                                <tr>
                                                    ...
                                                    <td class="uk-text-center"><?= $this->wowrealm->getCharHKs($chars->guid, $multiRealm) ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
